  ...
  if (!$process8->isSuccessful()) {
     ...
     // dd($extension);
      ...
      /*  $process0 = new Process(' convert -version
       ...
       '.$path.'\image\U-one-16.jpg 
        ...
        $process = new Process('magick convert   '.$path.'\image\U-one-16.jpg[403x422+560+571] 
       -colorspace gray 
       -blur 10x250 
       -auto-level
   ...
   if (!$process1->isSuccessful()) {
       ...
       $Y = 571 +  (422-$height)/2;
        ...
        $process3 = new Process('magick convert 
       '.$path.'\image\U-one-16.jpg[403x422+'.$X.'+'.$Y.'] 
       -colorspace gray -blur 10x250 -auto-level 
       -depth 16 
    ...
    if (!$process8->isSuccessful()) {
      ...
      public function uploadMockup11(Request $request){
       ...
       /*    $process12 = new Process('magick convert  '.$path.'\image\U-one-23-edit.jpg 
         ...
         $process = new Process('magick convert   '.$path.'\image\U-one-3.jpg[403x422+535+601] 
         -colorspace gray 
         -blur 20x250 
         -auto-level
     ...
     if (!$process1->isSuccessful()) {
         ...
         echo '<img src="\image\ms_temp.png">';
            ...
            $process3 = new Process('magick convert 
         '.$path.'\image\U-one-3.jpg[403x422+535+601] 
         -colorspace gray -blur 10x250 -auto-level 
         -depth 16 
    ...
    if (!$process8->isSuccessful()) {
      ...
      public function uploadMockup12(Request $request){
       ...
       /*    $process12 = new Process('magick convert  '.$path.'\image\U-one-23-edit.jpg 
         ...
         $process = new Process('magick convert   '.$path.'\image\U-one-15.jpg[303x322+615+751] 
         -colorspace gray 
         -blur 20x250 
         -auto-level
     ...
     if (!$process1->isSuccessful()) {
         ...
         echo '<img src="\image\ms_temp.png">';
            ...
            $process3 = new Process('magick convert 
         '.$path.'\image\U-one-15.jpg[303x322+615+751] 
         -colorspace gray -blur 10x250 -auto-level 
         -depth 16 
         '.$path.'\image\ms_displace_map.png
          ');
    ...
    if (!$process8->isSuccessful()) {
     ...
     if (!$process1->isSuccessful()) {
         ...
         echo '<img src="\image\ms_temp.png">';
            ...
            $process3 = new Process('magick convert 
         '.$path.'\image\U-one-8.jpg[303x322+625+731] 
         -colorspace gray -blur 10x250 -auto-level 
         -depth 16 
         '.$path.'\image\ms_displace_map.png
          ');
    ...
    if (!$process8->isSuccessful()) {
      ...
      public function uploadMockup14(Request $request){
       ...
       /*    $process12 = new Process('magick convert  '.$path.'\image\U-one-23-edit.jpg 
         ...
         $process = new Process('magick convert   '.$path.'\image\U-one-18.jpg[303x322+610+731] 
         -colorspace gray 
         -blur 20x250 
         -auto-level
     ...
     if (!$process1->isSuccessful()) {
         ...
         echo '<img src="\image\ms_temp.png">';
            ...
            $process3 = new Process('magick convert 
         '.$path.'\image\U-one-18.jpg[303x322+610+731] 
         -colorspace gray -blur 10x250 -auto-level 
         -depth 16 
         '.$path.'\image\ms_displace_map.png
          ');
