        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-9 copy-right">
                ...
                <div>
                    ...
                    <p>Please note that all payments will be effected in Euro (EUR). If the payment is done using foreign issuers payment cards,
                         total amount of transaction will be converted into bank settlement currency, according to the current exchange rate of Visa/Mastercard.
                    </p>
                </div>  
                <div>
