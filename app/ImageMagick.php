...
class ImageMagick extends Model
{
    ...
    ");
        ...
        $imageRandom = ImageMagick::randomStringPNG();
   ...
   ");
    ...
    public static function womanNavyTshirt($id, $image){
      ...
      exec("convert  ".$path."/site-images/U-one-13.jpg \
      -resize 1500x2500 \
  ...
  exec("convert  ".$path."/site-images/U-one-13.jpg[303x322+599+561] \
  -colorspace gray \
  -blur 10x250 \
  -auto-level\
  ".$path."/image/displace_map_navy_girl.png
   ");

         $imageName1 = "/" .  $image;


   exec("convert  ".$path."/design" . $imageName1 . " \
   -resize 300x300 \
   ".$path."/resized_pictures" . $imageName1 . "
   ");
        ...
        exec("convert ".$path."/resized_pictures" . $imageName1 . " \
        -bordercolor transparent \
        -border 12x12 \
        -thumbnail 303x322 \
        ".$path."/image/ms_temp_navy_girl.png
         ");
   ...
   ".$path."/image/ms_displace_map_girl_navy_regular.png
    ...
    -compose displace -set option:compose:args -5x-5 -composite \
    -depth 16 \
    ".$path."/image/ms_displaced_logo_navy_girl.png
     ");
  ...
  ".$path."/image/ms_displaced_logo_navy_girl.png \
  -channel matte -separate \
  ".$path."/image/ms_logo_displace_mask_navy_girl.png
   ");
...
".$path."/image/ms_logo_displace_mask_navy_girl.png \
-compose CopyOpacity -composite \
".$path."/image/ms_light_map_logo_navy_girl.png
");
    ...
    $imageRandom = ltrim($imageRandom, "/");
      ...
      public static function womanRedTshirt($id , $image ){
       ...
       exec("convert  ".$path."/site-images/U-one-6.jpg \ 
       -resize 1500x2500 \
       ".$path."/site-images/U-one-6.jpg
        ");


  exec("convert   ".$path."/site-images/U-one-6.jpg[303x322+610+531] \
  -colorspace gray \
  -blur 10x250 \
  -auto-level \
  ".$path."/image/displace_map_girl_red_regular.png
   ...
   ".$path."/resized_pictures" . $imageName1 . " \
   -bordercolor transparent -border 12x12 -thumbnail 303x322 \
   ".$path."/image/ms_temp_red_girl.png
    ");
   ...
   ".$path."/image/ms_displaced_logo_girl_red_regular.png \
   -channel matte -separate \
   ".$path."/image/ms_logo_displace_mask_red_girl.png
    ");
  ...
  ".$path."/image/ms_logo_displace_mask_red_girl.png \
  -compose CopyOpacity -composite \
  ".$path."/image/ms_light_map_logo_red_girl.png
  ");
 ...
 ");
      ...
      public static function womanBlackTshirt($id, $image){
       ...
       exec("convert  ".$path."/site-images/U-one-5.jpg \
       -resize 1500x2500 \
     ...
     ".$path."/resized_pictures" . $imageName1 . " \
     -bordercolor transparent -border 12x12 -thumbnail 303x322 \
     ".$path."/image/ms_temp_black_girl.png
      ");
   ...
   ".$path."/image/ms_displaced_logo_girl_black_regular.png \
   -channel matte -separate \
   ".$path."/image/ms_logo_displace_mask_black_girl.png
    ");
    ...
    ".$path."/image/ms_logo_displace_mask_black_girl.png \
    -compose CopyOpacity -composite \
    ".$path."/image/ms_light_map_logo_black_girl.png
    ");
  ...
  ");
    ...
    public static function manWhiteTshirt($id, $image){
        ...
        exec("convert ".$path."/site-images/U1-Obicnamajica-Bijela-Frontalno1.jpg \
        -resize 1500x2500 \
    ...
    exec("convert   ".$path."/site-images/U1-Obicnamajica-Bijela-Frontalno1.jpg[303x322+570+541] \
    -colorspace gray \
    -blur 10x250 \
    -auto-level \
    ".$path."/image/displace_map_white_man.png
     ");
     ...
     ");
        ...
        ".$path."/resized_pictures" . $imageName1 . " \
        -bordercolor transparent -border 12x12 -thumbnail 303x322 \
        ".$path."/image/ms_temp_white_man.png
        ");
   ...
   -compose displace -set option:compose:args -5x-5 -composite \
   -depth 16 \
   ".$path."/image/ms_displaced_logo_white_man.png
   ...
   ".$path."/image/ms_displaced_logo_white_man.png \
   -channel matte -separate \
   ".$path."/image/ms_logo_displace_mask_white_man.png
    ");
   ...
   ".$path."/image/ms_logo_displace_mask_white_man.png \
   -compose CopyOpacity -composite \
   ".$path."/image/ms_light_map_logo_white_man.png
   ");
  ...
  ");
    ...
    public static function manBlackTshirt($id, $image){
        ...
        exec("convert ".$path."/site-images/U1-Obicnamajica-Crna-Frontalno.jpg \
        -resize 1500x2500 \
        ".$path."/site-images/U1-Obicnamajica-Crna-Frontalno.jpg
         ");


    exec("convert   ".$path."/site-images/U1-Obicnamajica-Crna-Frontalno.jpg[303x322+590+541] \
    -colorspace gray \
    -blur 10x250 \
    -auto-level \
    ".$path."/image/displace_map_black_man.png
     ");
  ...
  ".$path."/resized_pictures" . $imageName1 . " \
  -bordercolor transparent -border 12x12 -thumbnail 303x322 \
  ".$path."/image/ms_temp_black_man.png
   ");
   ...
   -colorspace gray -blur 10x250 -auto-level \
   -depth 16 \
   ".$path."/image/ms_displace_map_man_black_regular.png
    ");
     ...
     -compose displace -set option:compose:args -5x-5 -composite \
     -depth 16 \
     ".$path."/image/ms_displaced_logo_black_man.png
      ");
  ...
  -contrast-stretch 0,30%% \
  -depth 16 \
  ".$path."/image/ms_light_map_man_black_regular.png
   ");
    ...
    ".$path."/image/ms_displaced_logo_black_man.png \
    -channel matte -separate \
    ".$path."/image/ms_logo_displace_mask_black_man.png
     ");
  ...
  ".$path."/image/ms_logo_displace_mask_black_man.png \
  -compose CopyOpacity -composite \
  ".$path."/image/ms_light_map_logo_black_man.png
  ");
  ...
  ");
    ...
    public static function manRedTshirt($id, $image){
        ...
        exec("convert ".$path."/site-images/U1-Obicnamajica-Crvena-Frontalno.jpg \
        -resize 1500x2500 \
    ...
    exec("convert   ".$path."/site-images/U1-Obicnamajica-Crvena-Frontalno.jpg[303x322+590+541] \
    -colorspace gray \
    -blur 10x250 \
    -auto-level \
    ".$path."/image/displace_map_red_man.png
     ");
   ...
   ".$path."/resized_pictures" . $imageName1 . " \
   -bordercolor transparent -border 12x12 -thumbnail 303x322 \
   ".$path."/image/ms_temp_red_man.png
    ");
   ...
   -colorspace gray -blur 10x250 -auto-level \
   -depth 16 \
   ".$path."/image/ms_displace_map_man_red_regular.png
    ");
   ...
   -compose displace -set option:compose:args -5x-5 -composite \
   -depth 16 \
   ".$path."/image/ms_displaced_logo_red_man.png
    ");
   ...
   -contrast-stretch 0,30%% \
   -depth 16 \
   ".$path."/image/ms_light_map_man_red_regular.png
    ");
   ...
   ".$path."/image/ms_displaced_logo_red_man.png \
   -channel matte -separate \
   ".$path."/image/ms_logo_displace_mask_red_man.png
    ");
   ...
   ".$path."/image/ms_logo_displace_mask_red_man.png \
   -compose CopyOpacity -composite \
   ".$path."/image/ms_light_map_logo_red_man.png
   ");
    ...
    public static function manNavyTshirt($id, $image){
        ...
        exec("convert ".$path."/site-images/U1-Obicnamajica-Teget-Frontalno.jpg \
        -resize 1500x2500 \
    ...
    exec ("convert   ".$path."/site-images/U1-Obicnamajica-Teget-Frontalno.jpg[303x322+610+541] \
    -colorspace gray \
    -blur 10x250 \
    -auto-level \
    ".$path."/image/displace_map_navy_man.png
     ");
   ...
   ".$path."/resized_pictures" . $imageName1 . " \
   -bordercolor transparent -border 12x12 -thumbnail 303x322 \
   ".$path."/image/ms_temp_navy_man.png
    ");
    ...
    -colorspace gray -blur 10x250 -auto-level \
    -depth 16 \
    ".$path."/image/ms_displace_map_man_navy_regular.png
     ");
   ...
   -compose displace -set option:compose:args -5x-5 -composite \
   -depth 16 \
   ".$path."/image/ms_displaced_logo_navy_man.png
    ");
 ...
 -colorspace gray -auto-level \
   ...
   -contrast-stretch 0,30%% \
   -depth 16 \
 ".$path."/image/ms_light_map_man_navy_regular.png
  ");
    ...
    ".$path."/image/ms_displaced_logo_navy_man.png \
    -channel matte -separate \
    ".$path."/image/ms_logo_displace_mask_navy_man.png
     ");
  ...
  -compose CopyOpacity -composite \
  ".$path."/image/ms_light_map_logo_navy_man.png
  ");
